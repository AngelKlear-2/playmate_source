...
import net.mcreator.knockknock.procedures.RehidingAIProcedure;
import net.mcreator.knockknock.procedures.RehidingOnInitialEntitySpawnProcedure;
...
public class RehidingEntity
extends Monster
implements GeoEntity {
    public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.m_135353_(RehidingEntity.class, EntityDataSerializers.f_135035_);
    public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.m_135353_(RehidingEntity.class, EntityDataSerializers.f_135030_);
    public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.m_135353_(RehidingEntity.class, EntityDataSerializers.f_135030_);
    ...
    public RehidingEntity(PlayMessages.SpawnEntity packet, Level world) {
        this((EntityType)KnockKnockModEntities.REHIDING.get(), world);
    }

    public RehidingEntity(EntityType<RehidingEntity> type, Level world) {
        super(type, world);
    ...
    protected void m_8097_() {
        ...
        this.f_19804_.m_135372_(TEXTURE, "hiding");
    }
    ...
    protected void m_8099_() {
        super.m_8099_();
        this.f_21345_.m_25352_(1, new RehidingEntity.1(this, this, Player.class, 200f, 1, 1));
    ...
    public SpawnGroupData m_6518_(ServerLevelAccessor world, DifficultyInstance difficulty, MobSpawnType reason, @Nullable SpawnGroupData livingdata, @Nullable CompoundTag tag) {
        ...
        RehidingOnInitialEntitySpawnProcedure.execute(world, this.m_20185_(), this.m_20186_(), this.m_20189_(), this);
        return retval;
    }

    public void m_6075_() {
        super.m_6075_();
        RehidingAIProcedure.execute(this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_(), this);
        this.m_6210_();
    }
