...
import net.mcreator.knockknock.procedures.NodeAiProcedure;
import net.mcreator.knockknock.procedures.NodeOnInitialEntitySpawnProcedure;
...
implements GeoEntity {
    public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.m_135353_(NodeEntity.class, EntityDataSerializers.f_135035_);
    public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.m_135353_(NodeEntity.class, EntityDataSerializers.f_135030_);
    public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.m_135353_(NodeEntity.class, EntityDataSerializers.f_135030_);
    ...
    public NodeEntity(PlayMessages.SpawnEntity packet, Level world) {
        this((EntityType)KnockKnockModEntities.NODE.get(), world);
    }

    public NodeEntity(EntityType<NodeEntity> type, Level world) {
        super(type, world);
    ...
    public SpawnGroupData m_6518_(ServerLevelAccessor world, DifficultyInstance difficulty, MobSpawnType reason, @Nullable SpawnGroupData livingdata, @Nullable CompoundTag tag) {
        ...
        NodeOnInitialEntitySpawnProcedure.execute(this);
        return retval;
    }

    public void m_6075_() {
        super.m_6075_();
        NodeAiProcedure.execute(this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_(), this);
        this.m_6210_();
    }

    public EntityDimensions m_6972_(Pose p_33597_) {
        return super.m_6972_(p_33597_).m_20388_(0.1f);
    }
    ...
    public static void init() {
        SpawnPlacements.m_21754_((EntityType)KnockKnockModEntities.NODE.get(), SpawnPlacements.Type.NO_RESTRICTIONS, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, NodeEntity::lambda$init$0);
    }

    public static AttributeSupplier.Builder createAttributes() {
        Builder builder = Mob.m_21552_();
        builder = builder.m_22268_(Attributes.f_22279_, 0);
