...
public class TrailerdummyEntity
extends Monster
implements GeoEntity {
    public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.m_135353_(TrailerdummyEntity.class, EntityDataSerializers.f_135035_);
    public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.m_135353_(TrailerdummyEntity.class, EntityDataSerializers.f_135030_);
    public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.m_135353_(TrailerdummyEntity.class, EntityDataSerializers.f_135030_);
    ...
    public TrailerdummyEntity(PlayMessages.SpawnEntity packet, Level world) {
        this((EntityType)KnockKnockModEntities.TRAILERDUMMY.get(), world);
    }

    public TrailerdummyEntity(EntityType<TrailerdummyEntity> type, Level world) {
        super(type, world);
