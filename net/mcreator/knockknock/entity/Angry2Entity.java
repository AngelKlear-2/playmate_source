...
import net.mcreator.knockknock.procedures.Angry2ThisEntityKillsAnotherOneProcedure;
import net.mcreator.knockknock.procedures.AngryAIProcedure;
import net.mcreator.knockknock.procedures.AngryPlayerCollidesWithThisEntityProcedure;
import net.mcreator.knockknock.procedures.Playerfound2Procedure;
...
public class Angry2Entity
extends Monster
implements GeoEntity {
    public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.m_135353_(Angry2Entity.class, EntityDataSerializers.f_135035_);
    public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.m_135353_(Angry2Entity.class, EntityDataSerializers.f_135030_);
    public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.m_135353_(Angry2Entity.class, EntityDataSerializers.f_135030_);
    ...
    public Angry2Entity(PlayMessages.SpawnEntity packet, Level world) {
        this((EntityType)KnockKnockModEntities.ANGRY_2.get(), world);
    }

    public Angry2Entity(EntityType<Angry2Entity> type, Level world) {
        super(type, world);
    ...
    protected void m_8099_() {
        super.m_8099_();
        this.f_21345_.m_25352_(1, new Angry2Entity.1(this, this, 1, false));
        this.f_21345_.m_25352_(2, new Angry2Entity.2(this, this, 1, false));
        this.f_21345_.m_25352_(3, new RandomStrollGoal(this, 1));
    ...
    public SpawnGroupData m_6518_(ServerLevelAccessor world, DifficultyInstance difficulty, MobSpawnType reason, @Nullable SpawnGroupData livingdata, @Nullable CompoundTag tag) {
        ...
        Playerfound2Procedure.execute(world, this.m_20185_(), this.m_20186_(), this.m_20189_(), this);
        return retval;
    }

    public void m_5993_(Entity entity, int score, DamageSource damageSource) {
        super.m_5993_(entity, score, damageSource);
        Angry2ThisEntityKillsAnotherOneProcedure.execute(this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_(), this);
    }

    public void m_6075_() {
        super.m_6075_();
        AngryAIProcedure.execute(this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_(), this);
        this.m_6210_();
    }

    public EntityDimensions m_6972_(Pose p_33597_) {
        return super.m_6972_(p_33597_).m_20388_(1f);
    }

    public void m_6123_(Player sourceentity) {
        super.m_6123_(sourceentity);
        AngryPlayerCollidesWithThisEntityProcedure.execute(this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_(), this, sourceentity);
    }
