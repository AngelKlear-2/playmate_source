...
public class TrailerdummyModel
extends GeoModel<TrailerdummyEntity> {
    public ResourceLocation getAnimationResource(TrailerdummyEntity entity) {
        return new ResourceLocation("knock_knock", "animations/silly.animation.json");
    }

    public ResourceLocation getModelResource(TrailerdummyEntity entity) {
        return new ResourceLocation("knock_knock", "geo/silly.geo.json");
    }

    public ResourceLocation getTextureResource(TrailerdummyEntity entity) {
        return new ResourceLocation("knock_knock", "textures/entities/" + entity.getTexture() + ".png");
    }

    public void setCustomAnimations(TrailerdummyEntity animatable, long instanceId, AnimationState animationState) {
