...
extends GeoModel<AngryEntity> {
    public ResourceLocation getAnimationResource(AngryEntity entity) {
        return new ResourceLocation("knock_knock", "animations/silly.animation.json");
    }

    public ResourceLocation getModelResource(AngryEntity entity) {
        return new ResourceLocation("knock_knock", "geo/silly.geo.json");
    }

    public ResourceLocation getTextureResource(AngryEntity entity) {
        return new ResourceLocation("knock_knock", "textures/entities/" + entity.getTexture() + ".png");
    }

    public void setCustomAnimations(AngryEntity animatable, long instanceId, AnimationState animationState) {
