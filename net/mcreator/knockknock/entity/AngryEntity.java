...
import net.mcreator.knockknock.procedures.AngryThisEntityKillsAnotherOneProcedure;
import net.mcreator.knockknock.procedures.PlayerfoundProcedure;
...
public class AngryEntity
extends Monster
implements GeoEntity {
    public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.m_135353_(AngryEntity.class, EntityDataSerializers.f_135035_);
    public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.m_135353_(AngryEntity.class, EntityDataSerializers.f_135030_);
    public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.m_135353_(AngryEntity.class, EntityDataSerializers.f_135030_);
    ...
    public AngryEntity(PlayMessages.SpawnEntity packet, Level world) {
        this((EntityType)KnockKnockModEntities.ANGRY.get(), world);
    }

    public AngryEntity(EntityType<AngryEntity> type, Level world) {
        super(type, world);
    ...
    protected void m_8099_() {
        super.m_8099_();
        this.f_21345_.m_25352_(1, new AngryEntity.1(this, this, 1, false));
        this.f_21345_.m_25352_(2, new RandomStrollGoal(this, 1));
    ...
    public SpawnGroupData m_6518_(ServerLevelAccessor world, DifficultyInstance difficulty, MobSpawnType reason, @Nullable SpawnGroupData livingdata, @Nullable CompoundTag tag) {
        ...
        PlayerfoundProcedure.execute(world, this.m_20185_(), this.m_20186_(), this.m_20189_(), this);
        return retval;
    }

    public void m_5993_(Entity entity, int score, DamageSource damageSource) {
        super.m_5993_(entity, score, damageSource);
        AngryThisEntityKillsAnotherOneProcedure.execute(this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_(), this);
    }
