...
import net.mcreator.knockknock.procedures.HidingAIProcedure;
import net.mcreator.knockknock.procedures.HidingOnInitialEntitySpawnProcedure;
...
public class HidingEntity
extends Monster
implements GeoEntity {
    public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.m_135353_(HidingEntity.class, EntityDataSerializers.f_135035_);
    public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.m_135353_(HidingEntity.class, EntityDataSerializers.f_135030_);
    public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.m_135353_(HidingEntity.class, EntityDataSerializers.f_135030_);
    ...
    public HidingEntity(PlayMessages.SpawnEntity packet, Level world) {
        this((EntityType)KnockKnockModEntities.HIDING.get(), world);
    }

    public HidingEntity(EntityType<HidingEntity> type, Level world) {
        super(type, world);
    ...
    public SpawnGroupData m_6518_(ServerLevelAccessor world, DifficultyInstance difficulty, MobSpawnType reason, @Nullable SpawnGroupData livingdata, @Nullable CompoundTag tag) {
        ...
        HidingOnInitialEntitySpawnProcedure.execute(world);
        return retval;
    }

    public void m_6075_() {
        super.m_6075_();
        HidingAIProcedure.execute(this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_(), this);
        this.m_6210_();
    }
