...
public class Trailerdummy2Entity
extends Monster
implements GeoEntity {
    public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.m_135353_(Trailerdummy2Entity.class, EntityDataSerializers.f_135035_);
    public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.m_135353_(Trailerdummy2Entity.class, EntityDataSerializers.f_135030_);
    public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.m_135353_(Trailerdummy2Entity.class, EntityDataSerializers.f_135030_);
    ...
    public Trailerdummy2Entity(PlayMessages.SpawnEntity packet, Level world) {
        this((EntityType)KnockKnockModEntities.TRAILERDUMMY_2.get(), world);
    }

    public Trailerdummy2Entity(EntityType<Trailerdummy2Entity> type, Level world) {
        super(type, world);
    ...
    private PlayState movementPredicate(AnimationState event) {
        if (this.animationprocedure.equals("empty")) {
            ...
            return event.setAndContinue(RawAnimation.begin().thenLoop("spotted"));
        }
